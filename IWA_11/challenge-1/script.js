...
const biscuits1 = document.querySelector("div.biscuits dd.count")
const donuts1 = document.querySelector("div.donuts dd.count")
const pancakes1 = document.querySelector("div.pancakes dd.count")
const status1 = document.querySelector("div.status dd")

const root2 = document.querySelector('dl[data-key = "order2"]')
const biscuits2 = document.querySelector("div.biscuits dd.count")
const donuts2 = document.querySelector("div.donuts dd.count")
const pancakes2 = document.querySelector("div.pancakes dd.count")
const status2 = document.querySelector("div.status dd")

const root3 = document.querySelector('dl[data-key = "order3"]')
const biscuits3 = document.querySelector("div.biscuits dd.count")
const donuts3 = document.querySelector("div.donuts dd.count")
const pancakes3 = document.querySelector("div.pancakes dd.count")
const status3 = document.querySelector("div.status dd")
